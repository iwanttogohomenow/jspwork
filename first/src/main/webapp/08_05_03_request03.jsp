...
<body>
<ul>
<li>요청정보 프로토콜 = <%= request.getProtocol()%></li> <!-- http의 버전까지 가져옴 -->
...
<!-- 
http://localhost:8090/first/08_05_03_request03.jsp?id=admin

url :
http://localhost:8090/first/08_05_03_request03.jsp

uri : 
/first/08_05_03_request03.jsp
